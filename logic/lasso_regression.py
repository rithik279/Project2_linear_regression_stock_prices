...
#Step 4: Apply Lasso Regression -> Or Whichever Model You Are Using
...
#How to improve the model: increase the amount of data that you have trained it on, 4 to 5 years is not enough data for a statistical model,
#Increase the lambda to penalize the model more, How to calculate the lambda value using cost validation, test different alpha models
